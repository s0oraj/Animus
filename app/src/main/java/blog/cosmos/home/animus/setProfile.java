...
public class setProfile extends AppCompatActivity {
        ...
        msaveprofile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                else
                {
                    ...
                    Intent intent=new Intent(setProfile.this, blog.cosmos.home.animus.chatActivity.class);
    ...
    private void sendDataToRealTimeDatabase()
    {
        ...
        blog.cosmos.home.animus.userprofile muserprofile=new blog.cosmos.home.animus.userprofile(name,firebaseAuth.getUid());
