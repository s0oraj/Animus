...
import blog.cosmos.home.animus.adapter.ChatUserAdapter;
import blog.cosmos.home.animus.model.ChatUserModel;
...
public class ChatUsersActivity extends AppCompatActivity {
    ...
    void clickListener() {
        ...
        adapter.OnStartChat((position, uids, chatID) -> {
            ...
            Intent intent = new Intent(ChatUsersActivity.this, blog.cosmos.home.animus.chat.ChatActivity.class);
