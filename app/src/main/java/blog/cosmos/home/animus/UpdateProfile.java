        ...
        mupdateprofilebutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                else if(imagepath!=null)
                {
                    ...
                    blog.cosmos.home.animus.userprofile muserprofile =new blog.cosmos.home.animus.userprofile(newname,firebaseAuth.getUid());
                    ...
                    Intent intent=new Intent(UpdateProfile.this, blog.cosmos.home.animus.chatActivity.class);
